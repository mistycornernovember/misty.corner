...
const sectionTitleStyle: React.CSSProperties = { fontSize: '1.6rem', borderBottom: '1.5px solid #eee', paddingBottom: '1.5rem', marginBottom: '4.5rem', letterSpacing: '0.15rem' };
const newsContainerStyle: React.CSSProperties = { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '5rem' };
const newsItemStyle: React.CSSProperties = { padding: '3rem', border: '1px solid #f0f0f0', background: 'rgba(255,255,255,0.65)' };
const itemTitleStyle: React.CSSProperties = { fontSize: '1.4rem', marginBottom: '2rem', fontWeight: 600 };
const newsTextStyle: React.CSSProperties = { fontSize: '1rem', lineHeight: '2.1', color: '#222' };
const contactListStyle: React.CSSProperties = { marginTop: '2rem', display: 'flex', flexDirection: 'column', gap: '1rem', fontSize: '0.95rem' };
const textLinkStyle: React.CSSProperties = { color: 'var(--text-color)', textDecoration: 'none', fontSize: '0.85rem', letterSpacing: '0.1rem', borderBottom: '1px solid #ddd' };
const stockistGridStyle: React.CSSProperties = { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '2.5rem' };
const stockistCardStyle: React.CSSProperties = { padding: '3rem 2rem', border: '1px solid #f0f0f0', textAlign: 'center', textDecoration: 'none', color: 'inherit', background: '#fff' };
const issueCardStyle: React.CSSProperties = { display: 'flex', flexDirection: 'column' };
const issueImageContainer: React.CSSProperties = { width: '100%', aspectRatio: '3/4.2', backgroundSize: 'cover', backgroundPosition: 'center', position: 'relative', backgroundColor: '#eee' };
const imageOverlay: React.CSSProperties = { position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', background: 'rgba(255,255,255,0.05)', backdropFilter: 'blur(1px)' };
const dateStyle: React.CSSProperties = { fontSize: '0.8rem', color: '#aaa', display: 'block', marginBottom: '2rem', letterSpacing: '0.05rem' };
const issueContentClassic: React.CSSProperties = { fontSize: '0.9rem', lineHeight: '2.1', color: '#444', marginTop: '1.5rem' };
...
const featureCardImage: React.CSSProperties = { width: '100%', height: '420px', backgroundSize: 'cover', backgroundPosition: 'center', position: 'relative', backgroundColor: '#eee' };
...
const prefaceStyle: React.CSSProperties = { fontSize: '1.1rem', lineHeight: '2.2', color: '#666', marginBottom: '6rem', fontStyle: 'italic', borderLeft: '3px solid #eee', paddingLeft: '2rem' };
const interviewFlowStyle: React.CSSProperties = { display: 'flex', flexDirection: 'column', gap: '4.5rem' };
const interviewTurnStyle: React.CSSProperties = { display: 'flex', flexDirection: 'column', gap: '2.2rem', fontSize: '1.2rem', lineHeight: '2.4', color: '#222' };
const footerStyle: React.CSSProperties = { padding: '8rem 0', borderTop: '1px solid #eee', textAlign: 'center', fontSize: '0.75rem', letterSpacing: '0.2rem', color: '#aaa' };
